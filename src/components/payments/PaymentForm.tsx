...
interface Props { initial?: Payment; onSave: (d: CreatePaymentInput) => void; onClose: () => void; loading?: boolean; }
...
export default function PaymentForm({ initial, onSave, onClose, loading }: Props) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit((d) => onSave({ ...d, amount: Number(d.amount), endDate: d.endDate || undefined }))} className="space-y-4">
